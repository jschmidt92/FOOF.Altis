...
- Attachment prices use config capability signals for suppressors, pointer/flashlight devices, optic zoom/range, and NV/TI capability instead of only flat item mass.
